...
<div region="north" border="false" style="overflow: hidden; width: 100%; height:50px; background:#D9E5FD;">
    <div style="overflow: hidden; width:200px; padding:2px 0 0 5px;">
        <h2>PerforMAD Admin</h2>
    </div>
    <div id="header-inner"
         style="float:right; overflow:hidden; height:80px; width:300px; line-height:25px; text-align:right; padding-right:20px;margin-top:-50px; ">
    ...
    <div style="padding:20px 20px 40px 80px;">
        <form id="form1" method="post">
            <table>
                <tr>
                    <td>旧密码</td>
                    <td><input type="password" name="oldpassword" class="easyui-validatebox" required="true"
                               validType="password[5,20]" missingMessage="请填写当前使用的密码"/></td>
                </tr>
                <tr>
                    <td>新密码：</td>
                    <td><input type="password" name="newpassword" class="easyui-validatebox" required="true"
                               validType="password[5,20]" missingMessage="请填写需要修改的密码"/></td>
                </tr>
                <tr>
                    <td>重复密码：</td>
                    <td><input type="password" name="repeatpassword" class="easyui-validatebox" required="true"
...
<div region="center" border="false">
    <div id="tt" class="easyui-tabs" style="height:800px;" data-options="fit:true">
